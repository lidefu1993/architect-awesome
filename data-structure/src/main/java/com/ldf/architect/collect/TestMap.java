...
public abstract class TestMap<K, V>  implements Map<K,V>   {
        ...
        if (ks == null) {
            ks = new AbstractSet<K>() {
                ...
                public boolean contains(Object k) {
                    return TestMap.this.containsKey(k);
                }
            };
            keySet = ks;
        }
        ...
        if (vals == null) {
            vals = new AbstractCollection<V>() {
                ...
                public boolean contains(Object v) {
                    return TestMap.this.containsValue(v);
                }
            };
            values = vals;
        }
    ...
    /**
     * Returns a shallow copy of this <tt>TestMap</tt> instance: the keys
     * and values themselves are not cloned.
     *
     * @return a shallow copy of this map
     */
    protected Object clone() throws CloneNotSupportedException {
        TestMap<?,?> result = (TestMap<?,?>)super.clone();
        result.keySet = null;
        result.values = null;
        return result;
    }
