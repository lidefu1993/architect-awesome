...
public class IntegerToRomanNumeral {
    ...
    public String intToRoman(int num) {
        ...
        while (true){
            if((temp = num/1000) >= 1){
                ...
                detail(s, temp, "C", "CD", "CM", "D");
                num %= 100;
            }else if((temp = num/10) >= 1 ){
                detail(s, temp, "X", "XL", "XC", "L");
                num %= 10;
            }else {
                temp = num;
                detail(s, temp, "I", "IV", "IX", "V");
                break;
            }
        }
        return s.toString();
    ...
    private void detail(StringBuilder s, int temp, String base, String four, String nine, String five){
        if(temp == 9){
            s.append(nine);
